...
%marshmallow 1
degree_vectors_m1 = [0 20 -150 120]; % gripper wrist elbow shoulder %replaced gripper angle -40 to 0
...
%marshmallow 2
degree_vectors_m2 = [0 10 -40 25]; % gripper wrist elbow shoulder 
desired_angle_vectors_m2 = deg2rad(degree_vectors_m2);
degree_vectors_drop2 = [0 -10 40 25]; % gripper wrist elbow shoulder 
desired_angle_vectors_drop2 = deg2rad(degree_vectors_drop2);

%marshmallow 3
degree_vectors_m3 = [0 120 210 20]; % gripper wrist elbow shoulder 
desired_angle_vectors_m3 = deg2rad(degree_vectors_m3);
degree_vectors_drop3 = [0 10 40 10]; % gripper wrist elbow shoulder 
desired_angle_vectors_drop3 = deg2rad(degree_vectors_drop3);


desired_angle_vectors_origin = [0 0 0 0]; %resting position
